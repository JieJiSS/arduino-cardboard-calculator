...
double BUTTON_OPPO[2] = {84.0 * KOhm, 84.2 * KOhm};
...
double BUTTON_NUM9[2] = {70.0 * KOhm, 71.2 * KOhm};
double BUTTON_NUM8[2] = {54.3 * KOhm, 55.0 * KOhm};
double BUTTON_NUM7[2] = {17.2 * KOhm, 17.4 * KOhm};
double BUTTON_NUM6[2] = {68.7 * KOhm, 69.0 * KOhm};
double BUTTON_NUM5[2] = {50.0 * KOhm, 51.0 * KOhm};
